...
import ScreenDangBai from '../screen/ScreenDangBai'
import ScreenAddBaiDang from '../screen/ScreenAddBaiDang'
...
const Stack5 = () => {
    return(
        <Stack.Navigator>
            ...
            <Stack.Screen name = "dangbai" component = {ScreenDangBai} options = {{title:"Bài đăng"}}/>
            <Stack.Screen name = "baidang" component = {ScreenAddBaiDang} options = {{title:"Thêm bài đăng"}}/>
        </Stack.Navigator>
    )
}
